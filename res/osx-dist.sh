...
create-dmg --icon "CloudBox.app" 200 190 --hide-extension "CloudBox.app" --window-size 800 400 --app-drop-link 600 185 rustdesk-$VERSION.dmg ./flutter/build/macos/Build/Products/Release/CloudBox.app
